 ...
 * @version 1.0.0
 * @license MIT
 * @description Этот класс реализует базовую систему событий для клиентского приложения WisteriaMC. 
 * Он позволяет различным частям приложения взаимодействовать друг с другом через события, не создавая жестких связей между ними.
 */
class EventEmitter {
  /**
